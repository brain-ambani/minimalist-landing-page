...
const MarketingPage = () => {
  return (
    <div className="flex items-center justify-center flex-col">
      <div className="flex items-center justify-center flex-col">
        <div
          className="mb-4 flex items-center border shadow-sm
        p-4 bg-amber-100 text-amber-700 rounded-full
        uppercase"
        >
        ...
        <h1
          className="text-3xl md:6xl text-center
      ...
      <div
       ...
       mt-4 max-w-xs md:max-w-2xl text-center mx-auto"
      >
        Collaborate, manage and track your tasks with ease. From high rises to
